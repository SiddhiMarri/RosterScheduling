...
class EntropyAdjustingCallback(BaseCallback):
    def __init__(self, verbose=0, min_episodes=10, increase_factor=1.5, decrease_factor=0.9,
...
# Combine callbacks
callback = CallbackList([checkpoint_callback,entropy_adjusting_callback, reward_logger, schedule_logger])
