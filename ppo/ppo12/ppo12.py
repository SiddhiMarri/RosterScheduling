...
class ATCSchedulingEnv_b(gym.Env):
    ...
    def __init__(self):
        ...
        self.penalties = {
            ...
            'INVALID_ACTION': -10,
            'DUPLICATE_ASSIGNMENT': -100,
            'INVALID_ASSIGNMENT': -100,
            'HOLIDAY_VIOLATION': -100
        }
        ...
        # Removed the "no controller" option
    ...
    def step(self, action):
        ...
        for position_idx, controller_idx in enumerate(role_assignments):
            ...
            if constraints_violated:
                continue  # Skip assignment due to constraints
...
class EpisodeRewardLogger(BaseCallback):
    def __init__(self, log_dir, verbose=0):
        ...
        self.csv_writer.writerow(['Episode', 'Reward', 'Violations', 'Invalid_Assignments', 'Non_Violated_Assignments'])  # Header
    ...
    def _on_step(self) -> bool:
        if self.locals['dones'][0]:
            ...
            # Log to CSV
            self.csv_writer.writerow([self.episode_num, reward, violations, invalid_assignments, non_violated_assignments])
            if self.verbose > 0:
            ...
            self.logger.record('episode/invalid_assignments', invalid_assignments)
